    ...
    <header className="fixed top-0 z-50 w-full border-b border-white/10 bg-stone-900/90 backdrop-blur-md text-white">
      <div className="container mx-auto flex h-20 items-center justify-between px-6">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <TrackedPhoneLink location="navbar-desktop">
            <Button className="bg-orange-600 hover:bg-orange-700 text-white font-bold uppercase tracking-wide rounded-none px-6">
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="bg-stone-900 border-stone-800 text-white overflow-y-auto p-6">
              ...
              <nav className="flex flex-col gap-6">
                ...
                <TrackedPhoneLink location="navbar-mobile">
                  <Button className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold h-12 uppercase tracking-wide rounded-none mt-8">
                    <Phone className="mr-2 h-4 w-4" />
                    Call Now
                  </Button>
                </TrackedPhoneLink>
