              ...
              <div className="grid gap-8">
                <div className="flex items-start gap-6 p-6 bg-stone-50 border border-stone-100 rounded-lg hover:border-stone-200 transition-colors">
                  ...
                  <div>
                    ...
                    <TrackedPhoneAnchor location="contact-info" className="text-2xl font-black text-stone-900 hover:text-green-600 transition-colors">{PHONE_NUMBER}</TrackedPhoneAnchor>
                  </div>
                </div>
