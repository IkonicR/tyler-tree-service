...
import { PHONE_NUMBER, COMPANY_NAME, ADDRESS, TYLER_ZIP_CODES, SURROUNDING_CITIES } from "@/lib/constants";
   ...
   return (
      <div className="flex min-h-screen flex-col bg-stone-50 font-sans selection:bg-green-200 selection:text-green-900">
         ...
         <main className="flex-1">
               ...
               <div className="container mx-auto px-6">
                  <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                     <div className="max-w-2xl">
                        ...
                        <TrackedPhoneLink location="home-emergency">
                           <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white text-lg font-bold h-14 px-10 rounded-none uppercase tracking-wider">
            ...
            <section className="py-32 bg-stone-900 text-white text-center">
               <div className="container mx-auto px-6">
                  ...
                  <TrackedPhoneLink location="home-footer-cta">
                     <Button size="lg" className="bg-green-600 hover:bg-green-700 text-white text-base md:text-lg font-bold h-auto py-6 px-6 md:h-20 md:px-12 rounded-none uppercase tracking-widest shadow-2xl hover:shadow-green-900/20 transition-all whitespace-normal text-center">
         ...
         <div className="md:hidden fixed bottom-0 left-0 right-0 z-50">
            <TrackedPhoneLink location="home-sticky-mobile">
               <Button className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold h-16 text-lg rounded-none uppercase tracking-wider shadow-[0_-4px_10px_rgba(0,0,0,0.3)]">
