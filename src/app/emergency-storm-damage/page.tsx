  ...
  return (
    <div className="flex min-h-screen flex-col bg-stone-50 font-sans selection:bg-red-200 selection:text-red-900">
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden bg-stone-900">
          ...
          <div className="container relative z-10 px-6 mx-auto text-center">
            ...
            <TrackedPhoneLink location="emergency-hero">
              <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white text-lg font-bold h-16 px-10 rounded-none uppercase tracking-wider shadow-red-900/50 shadow-lg">
        ...
        <section className="py-24 bg-white text-center">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <TrackedPhoneLink location="emergency-cta">
              <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white text-lg font-bold h-16 px-12 rounded-none uppercase tracking-widest shadow-xl">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50">
        <TrackedPhoneLink location="emergency-sticky-mobile">
          <Button className="w-full bg-red-600 hover:bg-red-700 text-white font-bold h-16 text-lg rounded-none uppercase tracking-wider shadow-[0_-4px_10px_rgba(0,0,0,0.3)]">
